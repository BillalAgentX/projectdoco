...
public class ExpandablePhotosFIlterListAdapter2 extends BaseExpandableListAdapter {
    ...
    public ExpandablePhotosFIlterListAdapter2(Context context, List<GroupheadingModel> listDataHeader) {
...
//                tv_end_date.setText(defectsModel.getFristDate());
                    ...
                    tv_start_date.setText(simpleDateFormat.format(date));
                }
...
//                tv_start_date.setText(header.get(groupPosition).getListChildData().get(header.get(groupPosition).getType()).get(0).getTitle());
                ...
                header.get(groupPosition).setStart_date(Long.valueOf(header.get(groupPosition).getListChildData().get(header.get(groupPosition).getType()).get(0).getId()));
