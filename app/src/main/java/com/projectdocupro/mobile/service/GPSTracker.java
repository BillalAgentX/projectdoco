...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void showSettingsAlert() {
        ...
        alertDialog
                .setMessage(mContext.getString(R.string.gps_settings_des));

        // On pressing Settings button
        alertDialog.setPositiveButton(mContext.getString(R.string.settings_title),
