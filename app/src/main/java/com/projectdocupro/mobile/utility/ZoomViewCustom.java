 ...
 * Zooming view.
 */
public class ZoomViewCustom extends RelativeLayout {
    ...
    public ZoomViewCustom(Context context, AttributeSet attrs) {
        super(context, attrs);

    }

    public ZoomViewCustom(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
       
    }

    public ZoomViewCustom(final Context context) {
        super(context);
    }
