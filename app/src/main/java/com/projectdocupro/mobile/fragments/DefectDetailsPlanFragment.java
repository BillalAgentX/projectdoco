 ...
 * {@link DefectDetailsPlanFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DefectDetailsPlanFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DefectDetailsPlanFragment extends Fragment implements PlansListItemClickListener {
    ...
    public DefectDetailsPlanFragment() {
    ...
    public static DefectDetailsPlanFragment newInstance(String param1, String param2) {
        DefectDetailsPlanFragment fragment = new DefectDetailsPlanFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Get data from db
        favoritePlansRepository =   new FavoritePlansRepository(getContext());
        favoritePlansRepository.getFavoritePlans().observe(this, plansModels -> {
            adapter =   new PlansRecyclerAdapter(plansModels,this);
