...
import com.projectdocupro.mobile.CameraPreview;
...
public class CameraActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     * An {@link com.projectdocupro.mobile.CameraPreview} for camera preview.
     */
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance("Grant Permission")
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    unlockFocus();
                    Intent  intent  =   new Intent(CameraActivity.this,SavePictureActivity.class);
                    intent.putExtra("picturePath",mFile.getAbsolutePath());
