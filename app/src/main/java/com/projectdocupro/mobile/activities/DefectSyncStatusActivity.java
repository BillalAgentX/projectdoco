...
public class DefectSyncStatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_defect_sync_info);
        bindView();
...
//        ll_parent.setLayoutParams(lpParent);
    ...
    private void populateCountData() {
        tv_total_photo_count.setText(Long.valueOf(allProjectSyncCount + allProjectUNSyncCount + allProjectShortlySyncCount) + "");
        tv_sync_photo_count.setText(Long.valueOf(allProjectSyncCount) + "");
        tv_un_sync_photo_count.setText(Long.valueOf(allProjectUNSyncCount) + "");
        tv_shortly_sync_photo_count.setText(Long.valueOf(allProjectShortlySyncCount) + "");


        tv_project_total_photo_count.setText(Long.valueOf(projectSyncCount + projectUNSyncCount + projectShortlySyncCount) + "");
        tv_project_sync_photo_count.setText(Long.valueOf(projectSyncCount) + "");
        tv_project_un_sync_photo_count.setText(Long.valueOf(projectUNSyncCount) + "");
