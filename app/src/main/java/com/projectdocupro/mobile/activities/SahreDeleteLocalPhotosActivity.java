...
public class SahreDeleteLocalPhotosActivity extends AppCompatActivity implements OnlinePhotosFragment.OnFragmentInteractionListener, ReportPhotoDetailFragment.OnFragmentInteractionListener {
            ...
            public void onClick(View v) {
                if (onlinePhotosFragment != null && onlinePhotosFragment.stringBuilderPhotoPath != null && !onlinePhotosFragment.stringBuilderPhotoPath.toString().equals("")) {
                    ...
                    for(String path : items /* List of the files you want to send */) {
                        ...
                        Uri photoURI = FileProvider.getUriForFile(SahreDeleteLocalPhotosActivity.this, SahreDeleteLocalPhotosActivity.this.getApplicationContext().getPackageName() + ".fileprovider", file);
//                        Uri uri = Uri.fromFile(file);
                    ...
                    Toast.makeText(SahreDeleteLocalPhotosActivity.this, getResources().getString(R.string.report_choose_photo_msg), Toast.LENGTH_SHORT).show();
                }
            }
        });
